...
#echo ${server_protocol}${server_ip}/Ipxe/boot/${os}/${version}/images/pxeboot/initrd.img ip=${client_ip} inst.repo=http://212.7.73.139/repo/rhel/7/x86_64/u2/ ks=${kicktart_filename} ${server_protocol}${server_ip}/kickstart_test/${os}/${version}/${client_hostname}/${client_domain_name}/ks.cfg
...
kernel ${server_protocol}${server_ip}/Ipxe/boot/${os}/${version}/images/pxeboot/vmlinuz initrd=initrd ifname=eth99:${client_network_mac} ip=${client_ip}::${client_gateway}:${client_netmask}:${client_hostname}:eth99:none inst.ks.sendmac inst.ks=${server_protocol}${server_ip}/kickstart_test/${os}/${version}/${client_hostname}/${client_domain_name}/ks.cfg
prompt
boot
goto back
